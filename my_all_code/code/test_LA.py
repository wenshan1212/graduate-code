...
parser.add_argument('--root_path', type=str, default='/workspace/my_all_code/data_split/LA/', help='Name of Experiment')
...
# python test_LA.py --labelnum 4 
# python test_LA.py --labelnum 8
