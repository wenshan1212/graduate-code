...
def self_train(args ,pre_snapshot_path, snapshot_path):
    ...
    for _ in iterator:
        for _, sampled_batch in enumerate(trainloader):
            ...
            ######################################
            iter_num += 1
            update_model_ema(model, dynamic_teacher_model, 0.95)
            ######################################
...
def main(args):
    ...
    shutil.copy('../code/ACDC_labelnum7_train.py', self_snapshot_path)
...
### python ACDC_labelnum7_train.py --gpu 0 --run_mode pretrain_then_selftrain